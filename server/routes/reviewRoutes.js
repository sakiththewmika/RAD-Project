...
router.delete('/:id', authentication, authorization(['planner']), async (request, response) => {
    try {
...
router.put('/:id', authentication, authorization(['planner']), async (request, response) => {
    try {
...
router.get('/service/:id', authentication, authorization(['provider', 'admin', 'planner']), async (request, response) => {
    try {
        const { id } = request.params;
...
router.post('/', authentication, authorization(['planner']), async (request, response) => {
    try {
        if (
